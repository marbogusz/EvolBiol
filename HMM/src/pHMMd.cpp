...
int main(int argc, char ** argv) {
	...
	try
	{
		...
		FileLogger::start(cmdReader->getLoggingLevel(), (string(cmdReader->getInputFileName()).append(".hmm.timelog")));
...
*/
		...
		else
		{
			...
			treefile.open((string(cmdReader->getInputFileName()).append(".hmm.timetree")).c_str(),ios::out);
