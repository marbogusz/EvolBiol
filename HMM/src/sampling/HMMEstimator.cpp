				...
				gtree(new GuideTree(inputSeqs)), tst(*gtree)
{
	...
	sme = new SubstitutionHMMEstimator(inputSequences, substModel ,ot, rateCategories, alpha, estimateAlpha, tripletIdxs.size());
...
void HMMEstimator::estimateParameters()
{
...
void HMMEstimator::rescoreSamples()
{
...
void HMMEstimator::sampleAlignments()
{
...
void HMMEstimator::calculateInitialHMMs(Definitions::ModelType model)
{
